...
const queries = {
  ...
  LIST_SERVICES: `select id, name, created_on from services where deleted_on = '${zeroTimestamp}' order by created_on desc`,
  GET_SERVICE: `select id, name, created_on from services where deleted_on = '${zeroTimestamp}' and id = $1`,
  ...
  USERS_COUNT: `select count(*) from users where service_id = $1 and deleted_on = '${zeroTimestamp}'`,
};
