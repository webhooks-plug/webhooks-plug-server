...
const queries = {
  ...
  CREATE_MESSAGE: `insert into messages (status, user_id, event_id, endpoint, sns_message_id) values ($1, $2, $3, $4, $5) returning id, user_id, event_id, endpoint, sns_message_id, created_on`,
